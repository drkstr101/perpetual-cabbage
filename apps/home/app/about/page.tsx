...
function SocialLink({
  ...
  return (
    <li className={clsx(className, 'flex')}>
      <Link
        href={href}
        className="group flex text-sm font-medium text-neutral-800 transition hover:text-primary-500 dark:text-neutral-200 dark:hover:text-primary-500"
      >
        <Icon className="h-6 w-6 flex-none fill-neutral-500 transition group-hover:fill-primary-500" />
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-neutral-600 dark:text-neutral-400">
            ...
            <p>
              ...
              climbed the 40-foot oak tree at the back of our yard while wearing my older sister’s
            ...
            <p>
              Today, I’m the founder of Planetaria, where we’re working on civilian space suits
              and manned shuttle kits you can assemble at home so that the next generation of kids
